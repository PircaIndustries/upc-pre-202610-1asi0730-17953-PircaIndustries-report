...
| **EP06** | **Seguridad, Salud y Cumplimiento** | Como supervisor de obra, quiero gestionar los permisos y equipos de protección para asegurar un entorno de trabajo bajo norma. | **Escenario 1: Control de EPP** <br>Dado que un trabajador ingresa a una zona de riesgo, <br>Cuando el sistema verifica su entrega de equipo de protección, <br>Entonces emite una alerta si el equipo está vencido o no ha sido entregado. <br><br>**Escenario 2: Validación de Permisos de Alto Riesgo** <br>Dado que se requiere realizar una tarea peligrosa (excavación o altura), <br>Cuando el supervisor intenta iniciar la actividad sin un PETAR aprobado, <br>Entonces el sistema bloquea el registro de avance y exige la carga del permiso firmado. |
...
<br>
<img src="Resources/Diagrams/Class Diagram - Aplicaciones Web.png" alt="Foto de Diagrama de Clases"/>
