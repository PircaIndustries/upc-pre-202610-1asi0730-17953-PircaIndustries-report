...
| **US-18** | Visualizar alerta de stock bajo | Como Encargado de Logística,<br>Quiero recibir una alerta visual cuando un material clave alcance su nivel mínimo,<br>Para generar órdenes de compra antes de que ocurra un quiebre de stock. | **Escenario 1: Disparador de alerta de stock**<br>Dado que un material tiene configurado un límite mínimo de 50 unidades,<br>Cuando el stock registrado desciende a 49 unidades o menos,<br>Entonces el sistema marca la fila del material en color rojo en la tabla de inventario,<br>Y activa un ícono de advertencia en el Dashboard principal. | EP03 |
