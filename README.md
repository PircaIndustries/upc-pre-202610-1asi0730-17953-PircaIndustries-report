...
| :--- | :--- | :--- | :--- | :--- |
| **US-01** | Registro de cuenta nueva | Como nuevo miembro del equipo, quiero registrarme en la plataforma para acceder a los datos del proyecto asignado. | **Escenario 1:** <br>Dado que el usuario accede por primera vez a la aplicación, <br>Cuando completa el formulario de registro con los campos obligatorios: Nombre completo, Correo electrónico, Contraseña alfanumérica y Rol Técnico, <br>Entonces el sistema crea la cuenta y lo redirige al Dashboard principal. <br><br>**Escenario 2:** <br>Dado que el usuario intenta registrarse, <br>Cuando ingresa un Correo electrónico que ya está registrado y envía el formulario, <br>Entonces el sistema detiene el proceso y muestra un mensaje de error. | **EP04** |
| **US-02** | Visualización en "Modo Obra" | Como residente, quiero activar el tema de alto contraste para visualizar datos bajo luz solar intensa sin fatiga. | **Escenario 1:** <br>Dado que el usuario se encuentra en la interfaz principal del proyecto, <br>Cuando activa el toggle "Modo Obra" en el menú de configuración visual, <br>Entonces la interfaz cambia la paleta de colores y aumenta el tamaño de fuente. <br><br>**Escenario 2:** <br>Dado que el "Modo Obra" está activo, <br>Cuando el usuario desactiva el toggle, <br>Entonces la interfaz restaura la paleta de colores y tipografía predeterminada del sistema. | **EP03** |
| **US-03** | Registro de incidencia RNC | Como supervisor, quiero registrar un Resultado No Conforme con fotos para que el error sea subsanado de inmediato. | **Escenario 1:** <br>Dado que el usuario detecta una falla técnica, <br>Cuando completa el formulario ingresando: Título, Partida afectada, Descripción detallada y adjunta al menos una fotografía, <br>Entonces el sistema guarda el registro RNC y envía un correo de alerta al Residente de Obra. <br><br>**Escenario 2:** <br>Dado que el usuario intenta enviar el formulario RNC, <br>Cuando el campo de "Fotografía adjunta" está vacío, <br>Entonces el botón de envío se deshabilita y se muestra un requerimiento visual solicitando evidencia. | **EP01** |
| **US-04** | Solicitud formal de materiales | Como residente, quiero enviar pedidos de insumos desde la app para evitar errores de comunicación por canales informales. | **Escenario 1:** <br>Dado que el usuario requiere materiales, <br>Cuando completa el requerimiento especificando: Nombre del insumo, Cantidad, Unidad de medida y Fecha máxima de llegada, <br>Entonces el sistema genera un ticket con estado "Pendiente" y asigna un ID de seguimiento alfanumérico. <br><br>**Escenario 2:** <br>Dado que el usuario tiene un requerimiento en estado "Pendiente", <br>Cuando accede a los detalles del ticket y modifica la cantidad solicitada, <br>Entonces el sistema actualiza el registro de la solicitud y notifica el cambio a la bandeja de Logística. | **EP02** |
| **US-05** | Visualizar alerta de stock bajo (cualquier material crítico) | Como Encargado de Logística, quiero recibir una alerta visual cuando cualquier material crítico (ej. acero, cemento) alcance su nivel mínimo, para generar órdenes de compra antes de que ocurra un quiebre de stock. | **Escenario 1: Disparador de alerta de stock**<br>Dado que un material (ej. acero, cemento, ladrillos) tiene configurado un límite mínimo,<br>Cuando el stock registrado desciende por debajo de ese límite,<br>Entonces el sistema marca la fila del material en color rojo en la tabla de inventario y activa un ícono de advertencia en el Dashboard principal. <br><br>**Escenario 2: Notificación automática diaria**<br>Dado que el stock actual está por debajo del límite mínimo, <br>Cuando el sistema ejecuta la verificación diaria a las 00:00 hrs, <br>Entonces el sistema envía un correo electrónico automatizado de "Aviso de Reposición" al Jefe de Compras. | **EP02** |
| **US-06** | Firma digital de actas (Token) | Como ingeniero residente, quiero firmar actas de conformidad con un token para asegurar la validez legal del cierre de etapa. | **Escenario 1:** <br>Dado que el usuario visualiza el acta de cierre de etapa, <br>Cuando ingresa el Token numérico de 6 dígitos enviado por SMS y presiona "Firmar", <br>Entonces el sistema valida el código e inserta el sello criptográfico de aprobación en el PDF. <br><br>**Escenario 2:** <br>Dado que el usuario intenta firmar el acta, <br>Cuando ingresa un Token incorrecto o expirado, <br>Entonces el sistema rechaza la solicitud, muestra el error "Token inválido" y mantiene el acta en estado "Sin firmar". | **EP01** |
| **US-07** | Validación de compra vs Presupuesto (con autorización especial) | Como jefe de compras, quiero que el sistema valide cada orden de compra contra el presupuesto asignado a la partida, bloqueándola o solicitando autorización especial según el excedente, para evitar pérdidas de utilidad. | **Escenario 1 (Bloqueo total):** <br>Dado que el usuario intenta procesar un pedido que excede el monto asignado en más de un 10%, <br>Cuando presiona el botón de registrar compra, <br>Entonces el sistema muestra un mensaje de error y bloquea la transacción. <br><br>**Escenario 2 (Aprobación normal):** <br>Dado que el usuario tiene un pedido dentro del presupuesto, <br>Cuando confirma la compra, <br>Entonces el sistema aprueba la transacción y descuenta el monto del presupuesto disponible. <br><br>**Escenario 3 (Autorización especial):** <br>Dado que el usuario intenta procesar un pedido que excede el presupuesto en un 10% o menos, <br>Cuando presiona el botón de registrar compra, <br>Entonces el sistema solicita una autorización especial de un usuario con rol de supervisor y permite la compra solo tras la aprobación. | **EP02** |
| **US-08** | Filtro de planos por especialidad | Como técnico, quiero filtrar los planos por tipo (Sanitarias, Eléctricas, etc.) para localizar el diseño vigente rápidamente. | **Escenario 1:** <br>Dado que el usuario visualiza el repositorio de planos, <br>Cuando selecciona la opción "Instalaciones Eléctricas" en el menú desplegable, <br>Entonces la tabla oculta cualquier archivo que no coincida con esa categoría. <br><br>**Escenario 2:** <br>Dado que el usuario necesita una búsqueda específica, <br>Cuando selecciona simultáneamente "Instalaciones Sanitarias" y el estado "Versión Aprobada", <br>Entonces la vista retorna únicamente los planos que cumplen con ambas condiciones. | **EP03** |
| **US-09** | Cálculo automático de KPI (PPC) | Como gerente, quiero visualizar el Porcentaje de Plan Completado semanal para medir la productividad real de la obra. | **Escenario 1:** <br>Dado que el usuario ingresa al módulo de indicadores, <br>Cuando el sistema procesa el total de tareas programadas y completadas de la semana en curso, <br>Entonces calcula el porcentaje de cumplimiento y muestra el resultado en un gráfico de barras. <br><br>**Escenario 2:** <br>Dado que el usuario visualiza el dashboard de indicadores, <br>Cuando selecciona un rango de fechas en el calendario, <br>Entonces el sistema recalcula el PPC considerando exclusivamente los registros de esa ventana de tiempo. | **EP01** |
| **US-10** | Historial de cambios en planos | Como arquitecto, quiero ver el registro de versiones de un plano para asegurar que el equipo no use diseños obsoletos. | **Escenario 1:** <br>Dado que el usuario hace clic en el ícono de "Historial" de un plano, <br>Cuando se abre el modal lateral, <br>Entonces se lista una tabla con el N° de Versión, Fecha de subida, Nombre del responsable y Notas de actualización. <br><br>**Escenario 2:** <br>Dado que el usuario visualiza la lista de versiones anteriores, <br>Cuando hace clic en el botón "Restaurar" de una versión específica, <br>Entonces el sistema reasigna la etiqueta de "Versión Aprobada" a ese archivo y pasa la versión actual a estado "Obsoleto". | **EP03** |
| **US-11** | Subir nueva versión de plano | Como Residente de Obra,<br>Quiero subir una nueva versión actualizada de un plano técnico,<br>Para asegurar que el equipo en campo construya basándose en el diseño final aprobado. | **Escenario 1: Subida de nueva versión exitosa**<br>Dado que el usuario abre el modal de actualización de plano,<br>Cuando carga un archivo PDF, selecciona la Categoría e ingresa un resumen de cambios,<br>Entonces el sistema actualiza el número de versión y marca este nuevo archivo como la versión vigente.<br><br>**Escenario 2: Archivo con formato inválido**<br>Dado que el usuario está en el flujo de carga,<br>Cuando intenta adjuntar un archivo diferente a .PDF o muy pesado,<br>Entonces la validación rechaza el archivo y lanza el mensaje: "Formato no soportado o archivo muy pesado". | **EP03** |
| **US-12** | Atender solicitud de materiales | Como Encargado de Logística,<br>Quiero cambiar el estado de las solicitudes de materiales a "Aprobado" o "Rechazado",<br>Para mantener al equipo de obra informado sobre la disponibilidad de los insumos. | **Escenario 1: Aprobación de requerimiento**<br>Dado que el encargado visualiza una solicitud "Pendiente",<br>Cuando selecciona la acción "Aprobar",<br>Entonces el estado de la solicitud cambia a "En Proceso de Compra" y se envía una notificación a la aplicación del Residente.<br><br>**Escenario 2: Rechazo justificado**<br>Dado que el encargado decide rechazar un requerimiento,<br>Cuando selecciona "Rechazar",<br>Entonces el sistema exige llenar un campo de texto con el "Motivo del rechazo" antes de permitir actualizar el estado. | **EP02** |
| **US-13** | Actualizar inventario general | Como Encargado de Logística,<br>Quiero actualizar las cantidades de los materiales en el almacén central,<br>Para mantener un registro exacto del stock físico disponible para las obras. | **Escenario 1: Ingreso de nuevo stock**<br>Dado que el usuario abre la gestión de un ítem existente,<br>Cuando ingresa un valor numérico positivo en la cantidad a sumar y guarda,<br>Entonces el sistema suma ese valor al stock actual del material y registra al usuario responsable.<br><br>**Escenario 2: Restricción de caracteres**<br>Dado que el usuario intenta modificar el inventario,<br>Cuando ingresa letras o números negativos,<br>Entonces el formulario bloquea la acción y lanza una alerta indicando que solo se permiten valores numéricos positivos. | **EP02** |
| **US-14** | Registrar avance diario de obra | Como Residente de Obra,<br>Quiero registrar el porcentaje de avance físico del proyecto diariamente,<br>Para mantener la trazabilidad de la ejecución real frente al cronograma. | **Escenario 1: Registro de avance porcentual**<br>Dado que el residente accede al reporte de jornada,<br>Cuando ingresa el Avance (valor de 1 a 100), selecciona la Fecha y adjunta una Observación,<br>Entonces el sistema guarda el reporte y el dashboard recalcula el progreso global del proyecto. <br><br>**Escenario 2: Validación de rango matemático**<br>Dado que el usuario completa el registro,<br>Cuando ingresa un porcentaje superior a 100 o inferior a 1,<br>Entonces el sistema marca el campo en rojo e impide guardar el reporte hasta corregir el valor. | **EP01** |
| **US-15** | Cambiar estado del proyecto | Como Administrador del Sistema,<br>Quiero modificar el estado global de una obra (ej. En ejecución, Paralizada, Finalizada),<br>Para reflejar la situación operativa actual ante todos los usuarios. | **Escenario 1: Paralización de obra**<br>Dado que el administrador está en la configuración del proyecto,<br>Cuando cambia el estado a "Paralizado" e ingresa la justificación,<br>Entonces el sistema bloquea la creación de nuevos requerimientos y planos en ese proyecto para todo el equipo.<br><br>**Escenario 2: Reactivación**<br>Dado que el proyecto figura como "Paralizado",<br>Cuando el administrador lo devuelve a "En Ejecución",<br>Entonces el sistema levanta las restricciones de registro y modificación en todos los módulos de esa obra. | **EP04** |
| **US-16** | Visualizar Dashboard logístico | Como Encargado de Logística,<br>Quiero visualizar un resumen gráfico de requerimientos pendientes y presupuesto ejecutado,<br>Para tomar decisiones de compra rápidas sin tener que cruzar datos de Excel. | **Escenario 1: Carga de indicadores principales**<br>Dado que el usuario logístico ingresa al panel principal,<br>Cuando el sistema carga los datos financieros,<br>Entonces la pantalla muestra un diagrama de pastel comparando solicitudes pendientes vs atendidas, y el monto total de las órdenes aprobadas.<br><br>**Escenario 2: Sin datos**<br>Dado que el mes recién inicia o no hay operaciones registradas,<br>Cuando se consulta el dashboard,<br>Entonces los gráficos muestran un mensaje indicando que no hay datos suficientes para el periodo. | **EP02** |
| **US-17** | Asignar roles a usuarios | Como Administrador del Sistema,<br>Quiero asignar o modificar los permisos de los trabajadores en la plataforma,<br>Para asegurar que cada empleado solo tenga acceso a los módulos correspondientes a su cargo. | **Escenario 1: Asignación de rol de Logística**<br>Dado que el administrador edita un perfil de usuario,<br>Cuando selecciona "Encargado de Logística" como nuevo rol y guarda,<br>Entonces el sistema actualiza los permisos, inhabilitando su acceso a Planos y otorgándole permisos de Inventario.<br><br>**Escenario 2: Prevención de auto-bloqueo**<br>Dado que el administrador intenta modificar sus propios permisos,<br>Cuando intenta asignarse un rol inferior en su perfil,<br>Entonces el sistema oculta la opción y muestra un aviso indicando que no puede degradar su rol. | **EP04** |
| **US-18** | Confirmación de recepción de materiales | Como Residente de Obra, quiero registrar si los materiales llegaron completos y en buen estado a la obra, para alertar a logística de envíos defectuosos por parte del proveedor. | **Escenario 1:** <br>Dado que el residente recibe un pedido en obra, <br>Cuando marca el ticket como "Recibido Conforme" en la aplicación, <br>Entonces el sistema cierra la solicitud y actualiza el estado a "Entregado". <br><br>**Escenario 2:** <br>Dado que el material llega incompleto o con errores técnicos, <br>Cuando el usuario selecciona "Recibido con Observaciones", <br>Entonces el sistema exige llenar un campo de texto detallando el faltante y envía una alerta urgente al Encargado de Logística. | **EP02** |
| **US-19** | Gestión de fechas límite de expedientes | Como Gestor Operativo, quiero configurar fechas de vencimiento para los trámites municipales, para recibir recordatorios automáticos y evitar multas o paralizaciones. | **Escenario 1:** <br>Dado que el usuario registra un nuevo expediente técnico, <br>Cuando establece una "Fecha Límite de Subsanación" en el calendario, <br>Entonces el sistema inicia un conteo regresivo visible en el panel del proyecto. <br><br>**Escenario 2:** <br>Dado que un expediente tiene una fecha límite configurada, <br>Cuando faltan exactamente 3 días calendario para su vencimiento, <br>Entonces el sistema envía un correo de "Alerta de Vencimiento Próximo" a los gestores asignados. | **EP01** |
| **US-20** | Generar enlace de reporte para clientes | Como Gerente, quiero generar un enlace de solo lectura con el resumen del avance, para enviarlo al cliente (inversor) y mantenerlo informado sin que necesite crear una cuenta. | **Escenario 1:** <br>Dado que el gerente necesita informar al cliente, <br>Cuando presiona "Generar Reporte Externo", <br>Entonces el sistema crea una URL única que muestra únicamente el gráfico del PPC actual y la galería de fotos de avance. <br><br>**Escenario 2:** <br>Dado que el cliente abre el enlace generado, <br>Cuando intenta navegar a otras secciones como "Presupuestos" o "Planos", <br>Entonces el sistema oculta esos menús de navegación, garantizando una vista de solo lectura. | **EP01** |
| **US-21** | Generación de Orden de Compra en PDF | Como Encargado de Logística, quiero exportar un requerimiento aprobado en formato PDF, para enviarlo como Orden de Compra formal al proveedor. | **Escenario 1:** <br>Dado que existe una solicitud en estado "Aprobada", <br>Cuando el usuario selecciona la opción "Exportar a PDF", <br>Entonces el sistema genera y descarga un documento con los datos del pedido y un espacio para la firma del proveedor. <br><br>**Escenario 2:** <br>Dado que el usuario visualiza una solicitud en estado "Pendiente" o "Rechazada", <br>Cuando busca la opción de exportación, <br>Entonces el botón "Exportar a PDF" se mantiene inactivo o invisible. | **EP02** |
| **US-22** | Descarga de planos para uso Offline | Como Residente de Obra, quiero descargar la versión vigente del plano a mi dispositivo, para poder consultarlo cuando esté en sótanos o áreas de la obra sin cobertura de internet. | **Escenario 1:** <br>Dado que el usuario tiene conexión a internet y visualiza la lista de planos, <br>Cuando presiona el ícono de "Descargar", <br>Entonces el archivo PDF se guarda en el almacenamiento local del dispositivo. <br><br>**Escenario 2:** <br>Dado que el usuario intenta descargar una versión marcada como "Obsoleta", <br>Cuando presiona el botón de descarga, <br>Entonces el sistema despliega una advertencia requiriendo confirmación antes de proceder. | **EP03** |
| **US-23** | Visor de planos con anotaciones digitales | Como residente de obra, quiero agregar anotaciones digitales (texto y dibujo libre) directamente sobre el plano de cimentación, para reportar interferencias detectadas en campo inmediatamente al equipo de diseño sin usar papel. | **Escenario 1 (Anotación):** <br>Dado que el usuario visualiza un plano en el visor, <br>Cuando selecciona la herramienta de texto o dibujo y marca una zona del plano, <br>Entonces el sistema guarda la anotación asociada a ese plano y coordenada específica. <br><br>**Escenario 2 (Reporte):** <br>Dado que el usuario tiene una o más anotaciones guardadas en el plano, <br>Cuando presiona el botón "Reportar interferencia", <br>Entonces el sistema envía una notificación automática al equipo de diseño con un enlace directo al plano anotado. | **EP03** |
| **US-24** | Exportación del Libro de Obra (Cierre) | Como Administrador del Sistema, quiero compilar toda la documentación histórica al finalizar el proyecto, para entregar el "Libro de Obra" digital exigido por ley. | **Escenario 1:** <br>Dado que el proyecto se ha marcado con el estado "Finalizado", <br>Cuando el administrador selecciona "Exportar Libro de Obra", <br>Entonces el sistema procesa y descarga un archivo ZIP que contiene todas las actas firmadas, RNCs resueltos y planos aprobados. <br><br>**Escenario 2:** <br>Dado que el proyecto aún está en estado "En Ejecución", <br>Cuando el administrador intenta generar la exportación total, <br>Entonces el sistema bloquea la acción indicando que el Libro de Obra solo puede emitirse al concluir el proyecto. | **EP01** |
| **US-25** | Directorio de Proveedores Frecuentes | Como Encargado de Logística, quiero mantener un registro de mis proveedores, para acelerar la emisión de órdenes de compra sin tener que buscar sus datos de contacto externamente. | **Escenario 1:** <br>Dado que el usuario accede al módulo de logística, <br>Cuando completa el formulario de "Nuevo Proveedor" con RUC, Razón Social y Correo, <br>Entonces el sistema añade el registro a la lista de contactos disponibles. <br><br>**Escenario 2:** <br>Dado que el usuario necesita generar una compra, <br>Cuando despliega el campo "Proveedor" en el formulario de pedido, <br>Entonces el sistema autocompleta las opciones basándose en los registros guardados previamente. | **EP02** |
| **US-26** | Recuperación de contraseña | Como usuario del sistema, quiero poder solicitar un enlace de restablecimiento si olvido mi contraseña, para recuperar el acceso a mi cuenta sin depender del administrador. | **Escenario 1:** <br>Dado que el usuario se encuentra en la pantalla de Login, <br>Cuando hace clic en "Olvidé mi contraseña" e ingresa su correo electrónico válido, <br>Entonces el sistema envía un enlace de recuperación seguro con vigencia de 15 minutos. <br><br>**Escenario 2:** <br>Dado que el usuario accede al enlace de recuperación, <br>Cuando ingresa la nueva contraseña y no cumple con el mínimo de seguridad, <br>Entonces el sistema bloquea el cambio y solicita una contraseña válida. | **EP04** |
| **US-27** | Desactivación de personal retirado | Como Administrador del Sistema, quiero desactivar la cuenta de un trabajador que dejó la empresa, para revocar su acceso sin borrar su nombre de los historiales de firmas y planos. | **Escenario 1:** <br>Dado que un trabajador ya no pertenece a la empresa, <br>Cuando el administrador cambia el estado de su cuenta a "Inactivo", <br>Entonces el sistema bloquea permanentemente el inicio de sesión de ese usuario. <br><br>**Escenario 2:** <br>Dado que el usuario ha sido marcado como "Inactivo", <br>Cuando se revisan planos antiguos o actas que él firmó, <br>Entonces su nombre permanece intacto en los registros históricos para mantener la integridad de la auditoría. | **EP04** |
| **US-28** | Notificaciones automáticas de nuevas versiones de planos | Como residente de obra, quiero recibir una alerta automática (push y email) cuando el arquitecto suba una nueva versión de un plano, para evitar continuar la construcción con diseños obsoletos. | **Escenario 1:** <br>Dado que el arquitecto sube una nueva versión de un plano, <br>Cuando el sistema procesa la actualización, <br>Entonces envía una notificación push y un correo electrónico a todos los usuarios que hayan visualizado ese plano previamente. <br><br>**Escenario 2:** <br>Dado que un usuario tiene desactivadas las notificaciones push en su perfil, <br>Cuando se genera una nueva versión de plano, <br>Entonces el sistema solo envía el correo electrónico de actualización. | **EP03** |
| **US-29** | Exportación de Dossier de Calidad en PDF | Como administrador de proyecto, quiero exportar un archivo PDF que contenga todo el historial de firmas electrónicas y aprobaciones de una etapa constructiva, para facilitar la entrega del proyecto a la municipalidad o al cliente final. | **Escenario 1:** <br>Dado que el usuario accede al módulo de una etapa finalizada, <br>Cuando selecciona "Exportar Dossier de Calidad", <br>Entonces el sistema genera un PDF con todas las actas firmadas digitalmente y su línea de tiempo de aprobaciones. <br><br>**Escenario 2:** <br>Dado que el usuario necesita incluir solo ciertas actas, <br>Cuando aplica un filtro por fechas o tipo de documento antes de exportar, <br>Entonces el PDF generado contiene únicamente los documentos seleccionados. | **EP01** |
...
| **US-31** | Eliminación de cuenta (soft delete) | Como administrador del sistema, quiero desactivar una cuenta sin eliminar sus datos históricos, para mantener la integridad de la auditoría. | **Escenario 1:** <br>Dado que el administrador accede a un perfil activo, <br>Cuando cambia el estado a "Inactivo", <br>Entonces el usuario no puede iniciar sesión. <br><br>**Escenario 2:** <br>Dado que el usuario fue desactivado, <br>Cuando se revisan registros históricos, <br>Entonces su nombre sigue visible. | **EP04** |
| **US-32** | Visualizar detalle de solicitud de material | Como residente de obra, quiero ver el detalle completo de una solicitud, para validar la información antes de seguimiento. | **Escenario 1:** <br>Dado que el usuario accede a una solicitud, <br>Cuando abre el detalle, <br>Entonces ve nombre, cantidad, unidad, estado y fecha. <br><br>**Escenario 2:** <br>Dado que un usuario sin permisos intenta acceder, <br>Cuando abre la solicitud, <br>Entonces el sistema bloquea la visualización. | **EP02** |
| **US-33** | Descargar acta firmada | Como usuario, quiero descargar un acta firmada, para almacenarla o compartirla externamente. | **Escenario 1:** <br>Dado que el acta está firmada, <br>Cuando el usuario presiona "Descargar", <br>Entonces el sistema descarga el PDF. <br><br>**Escenario 2:** <br>Dado que el acta no está firmada, <br>Cuando el usuario intenta descargar, <br>Entonces el botón está deshabilitado. | **EP01** |
| **US-34** | Ordenar lista de planos | Como usuario técnico, quiero ordenar los planos por fecha o versión, para encontrar rápidamente el más reciente. | **Escenario 1:** <br>Dado que el usuario visualiza la lista, <br>Cuando selecciona "Ordenar por fecha", <br>Entonces los planos se reorganizan. <br><br>**Escenario 2:** <br>Dado que el usuario selecciona "Ordenar por versión", <br>Entonces el sistema ordena de mayor a menor. | **EP03** |
| **US-35** | Visualizar presupuesto restante | Como jefe de compras, quiero ver el presupuesto disponible de una partida, para tomar decisiones antes de comprar. | **Escenario 1:** <br>Dado que el usuario accede a una partida, <br>Cuando abre el detalle, <br>Entonces ve el monto asignado y el saldo restante. <br><br>**Escenario 2:** <br>Dado que se registra una compra, <br>Cuando se completa la transacción, <br>Entonces el saldo se actualiza automáticamente. | **EP02** |
| **US-36** | Visualizar lista de usuarios del proyecto | Como administrador, quiero ver todos los usuarios asignados a un proyecto, para gestionar el equipo de trabajo. | **Escenario 1:** <br>Dado que el administrador accede al proyecto, <br>Cuando entra al módulo de usuarios, <br>Entonces visualiza nombres, roles y estado. <br><br>**Escenario 2:** <br>Dado que se agrega o elimina un usuario, <br>Cuando se refresca la vista, <br>Entonces la lista refleja el cambio. | **EP04** |
| **US-37** | Marcar notificación como leída | Como usuario, quiero marcar una notificación como leída, para mantener organizado mi panel. | **Escenario 1:** <br>Dado que el usuario tiene notificaciones, <br>Cuando marca una como leída, <br>Entonces desaparece el indicador visual. <br><br>**Escenario 2:** <br>Dado que la notificación fue leída, <br>Cuando el usuario vuelve a entrar, <br>Entonces se mantiene como leída. | **EP04** |
| **US-38** | Visualizar materiales por categoría | Como encargado de logística, quiero filtrar materiales por categoría, para gestionar mejor el inventario. | **Escenario 1:** <br>Dado que el usuario está en inventario, <br>Cuando selecciona una categoría, <br>Entonces se muestran solo los materiales correspondientes. <br><br>**Escenario 2:** <br>Dado que no hay materiales en la categoría, <br>Cuando aplica el filtro, <br>Entonces el sistema muestra "Sin resultados". | **EP02** |
| **US-39** | Visualizar estado del proyecto | Como usuario, quiero ver el estado actual del proyecto, para entender su situación operativa. | **Escenario 1:** <br>Dado que el usuario accede al dashboard, <br>Cuando se carga el proyecto, <br>Entonces se muestra el estado (En ejecución, Paralizado, Finalizado). <br><br>**Escenario 2:** <br>Dado que el estado cambia, <br>Cuando el usuario vuelve a ingresar, <br>Entonces visualiza el nuevo estado. | **EP04** |
| **US-40** | Confirmar eliminación de registro | Como usuario, quiero confirmar antes de eliminar un registro, para evitar acciones accidentales. | **Escenario 1:** <br>Dado que el usuario presiona "Eliminar", <br>Cuando aparece el modal de confirmación, <br>Entonces debe aceptar para continuar. <br><br>**Escenario 2:** <br>Dado que el usuario cancela, <br>Cuando cierra el modal, <br>Entonces el registro no se elimina. | **EP04** |
| **US-41** | Bitácora fotográfica de excavaciones | Como supervisor de obras, quiero crear una galería específica para la etapa de excavación para documentar el tipo de suelo encontrado y evitar reclamos futuros. | **Escenario 1: Organización cronológica de fotos** <br>Dado que se realiza una excavación, <br>Cuando el usuario sube fotos bajo la etiqueta "Suelo", <br>Entonces el sistema las organiza automáticamente en un álbum cronológico dentro de la etapa de excavación. <br><br>**Escenario 2: Generación de informe fotográfico** <br>Dado que el cliente solicita evidencia del terreno, <br>Cuando el supervisor selecciona las fotos de la bitácora, <br>Entonces el sistema permite exportar un PDF con las imágenes, fechas y coordenadas del hallazgo. | **EP01** |
| **US-42** | Seguimiento de órdenes de cambio | Como arquitecto ayudante de logística, quiero registrar modificaciones al contrato original solicitadas por el cliente para ajustar el presupuesto y cronograma oficial. | **Escenario 1: Registro de modificación presupuestal** <br>Dado que el cliente solicita un cambio de diseño, <br>Cuando el arquitecto registra la "Orden de Cambio", <br>Entonces el sistema calcula automáticamente el impacto en el presupuesto total y lo muestra como un pendiente de aprobación. <br><br>**Escenario 2: Actualización del cronograma** <br>Dado que la modificación implica más tiempo de ejecución, <br>Cuando se confirma la orden de cambio, <br>Entonces el sistema extiende las fechas de las tareas relacionadas en el cronograma oficial. | **EP01** |
| **US-43** | Control de herramientas asignadas | Como ayudante de logística, quiero registrar las herramientas eléctricas asignadas (taladros, amoladoras) a un obrero específico para que sea el responsable de su devolución en buen estado. | **Escenario 1: Asignación de responsabilidad** <br>Dado que un operario solicita un taladro, <br>Cuando el ayudante de logística vincula el equipo al DNI del trabajador en la app, <br>Entonces el estado de la herramienta cambia a "En Uso por [Nombre]". <br><br>**Escenario 2: Registro de devolución con daños** <br>Dado que el operario devuelve la herramienta, <br>Cuando el ayudante registra el retorno, <br>Entonces el sistema permite marcar si el equipo regresó en "Buen estado" o "Con observaciones/daños". | **EP02** |
| **US-44** | Exportación de reporte de asistencia mensual | Como supervisor de obra, quiero exportar las asistencias del mes a un archivo CSV para facilitar el cálculo de la planilla en el software contable. | **Escenario 1: Generación de archivo CSV** <br>Dado que termina el periodo mensual, <br>Cuando el supervisor selecciona "Exportar Asistencias", <br>Entonces el sistema genera un archivo CSV compatible con software contable que contiene los días laborados por trabajador. <br><br>**Escenario 2: Filtro por proyecto específico** <br>Dado que el supervisor gestiona varias obras, <br>Cuando aplica el filtro de "Proyecto A" antes de exportar, <br>Entonces el archivo descargado contiene únicamente el personal asignado a esa ubicación. | **EP04** |
| **US-45** | Visualización de planos en 3D | Como arquitecto ayudante de logística, quiero visualizar modelos 3D sencillos (formatos glTF/OBJ) para realizar implementaciones extra de manera efectiva. | **Escenario 1: Visualización de interferencias** <br>Dado que existe un modelo 3D cargado, <br>Cuando el arquitecto abre el visor, <br>Entonces el sistema permite rotar y hacer zoom sobre la estructura para inspeccionar cruces de tuberías antes de la ejecución física. <br><br>**Escenario 2: Compatibilidad de formatos** <br>Dado que el usuario intenta subir un modelo, <br>Cuando el archivo está en formato .glTF o .OBJ, <br>Entonces el sistema procesa la carga y habilita la vista interactiva en 3D. | **EP03** |
| **US-46** | Gestión de residuos de construcción | Como ayudante de logística, quiero registrar el volumen de residuos retirados de la obra para cumplir con la normativa ambiental municipal. | **Escenario 1: Registro de retiro de desmonte** <br>Dado que un camión retira residuos, <br>Cuando el usuario ingresa el volumen (m³) y la placa del vehículo, <br>Entonces el sistema suma el acumulado al reporte de cumplimiento ambiental. <br><br>**Escenario 2: Alerta de acumulación crítica** <br>Dado que el depósito temporal de residuos alcanza el 80% de su capacidad, <br>Cuando el sistema detecta el volumen, <br>Entonces envía una alerta para programar el retiro de materiales. | **EP01** |
| **US-47** | Registro de mantenimiento de maquinaria | Como ayudante de logística, quiero programar alertas de mantenimiento para las mezcladoras según horas de uso para evitar paradas por avería. | **Escenario 1: Alerta por horas de uso** <br>Dado que una mezcladora alcanza el hito de mantenimiento (ej. 500 horas), <br>Cuando el sistema detecta el valor, <br>Entonces envía una notificación automática al encargado para programar el servicio técnico. <br><br>**Escenario 2: Historial de mantenimientos preventivos** <br>Dado que se realiza un servicio, <br>Cuando el técnico registra la actividad en la app, <br>Entonces el contador de horas se reinicia y el evento queda guardado en el historial de la máquina. | **EP02** |
| **US-48** | Landing page - Contenido para gestores operativos | Como arquitecto o ingeniero que visita el sitio, quiero encontrar información específica sobre cómo Kipu mejora la supervisión técnica y trazabilidad de obra para evaluar si se adapta a mis necesidades profesionales. | **Escenario 1:** <br>Dado que un visitante está en la sección pública de soluciones operativas, <br>Cuando hace scroll leyendo las especificaciones de RNC y PPC, <br>Entonces los botones "Crear cuenta gratuita" se mantienen visibles y funcionales. <br><br>**Escenario 2:** <br>Dado que el visitante decide iniciar el registro, <br>Cuando hace clic en "Crear cuenta gratuita", <br>Entonces el sistema lo redirige al formulario de registro pre-llenando su perfil como "Gestor Operativo". | **EP05** |
| **US-49** | Landing page - Contenido para equipos de logística | Como responsable de logística o administración que visita el sitio, quiero encontrar información específica sobre cómo Kipu centraliza pedidos y controla presupuestos para convencerme de su utilidad en mi área. | **Escenario 1:** <br>Dado que el visitante lee las funcionalidades de inventario, <br>Cuando hace clic en "Solicitar Demostración", <br>Entonces se despliega un formulario exigiendo sus datos de contacto. <br><br>**Escenario 2:** <br>Dado que el visitante completa el formulario de demostración, <br>Cuando presiona el botón "Enviar", <br>Entonces el sistema guarda la información y muestra una pantalla de confirmación informando que será contactado a la brevedad. | **EP05** |
